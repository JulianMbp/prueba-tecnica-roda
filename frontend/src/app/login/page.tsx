...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-roda-gray-900 via-roda-black to-roda-dark flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="w-full max-w-sm sm:max-w-md relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-roda-yellow mb-3 drop-shadow-lg">
            Roda
          </h1>
          <p className="text-roda-gray-200 text-lg sm:text-xl font-medium">
            Cronograma de Pagos
          </p>
        </div>

        {/* Formulario de búsqueda con sombra mejorada */}
        <div className="bg-roda-white rounded-2xl shadow-2xl p-6 sm:p-8 border border-roda-gray-200/20 backdrop-blur-sm">
          <ClientSearchForm onSearch={handleSearch} isLoading={isLoading} />
        </div>

        {/* Error message */}
        {error && (
          <div className="mt-4 sm:mt-6 p-4 bg-roda-error/10 border border-roda-error/30 rounded-xl backdrop-blur-sm">
        ...
        <div className="mt-6 sm:mt-8 text-center px-2">
          <p className="text-roda-gray-300 text-sm sm:text-base leading-relaxed">

          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-roda-dark">
            {isAuthenticated && clientInfo ? (
              <div className="space-y-2">
                <div className="text-roda-white text-sm px-3 py-2">
                ...
                <button
                  onClick={logout}
                  className="w-full text-left px-3 py-2 text-sm text-roda-gray-300 hover:text-roda-white hover:bg-roda-dark rounded-md transition-colors"
                >
                  Salir
                </button>
              </div>
